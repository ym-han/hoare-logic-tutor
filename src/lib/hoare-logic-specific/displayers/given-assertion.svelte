<script lang="ts" module>
	...
	import { GivenAssertionAlrNode } from '$lib/hoare-logic-specific/alr/index.ts';
	import {
		FeedbackAlrNode,
	...
	export interface GivenAssertionDisplayerProps extends DisplayerProps {
		node: GivenAssertionAlrNode; // specializing the node
	}
</script>

<script lang="ts">
	let { context, node }: GivenAssertionDisplayerProps = $props();
...
<div class="text-purple-800 {debouncedFeedback.current.getAttemptStyles(context).getStyles()}">
