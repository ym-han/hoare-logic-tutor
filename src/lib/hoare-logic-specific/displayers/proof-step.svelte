<script lang="ts" module>
  ...
  import {
    ...
    ScaffoldedAssertionHoleAndFeedbackDisplayer,
  ...
  import {
    ...
    isRemarkAlrNode,
    isScaffoldedAssertionHoleAndFeedbackAlrNode
...
<script lang="ts">
  ...
  const getComponent = (node: ProofStepAlrNode) =>
    match(node)
      ...
      .with(P.when(isScaffoldedAssertionHoleAndFeedbackAlrNode), () => ScaffoldedAssertionHoleAndFeedbackDisplayer)
