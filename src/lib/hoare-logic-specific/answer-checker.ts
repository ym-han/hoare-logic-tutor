...
export class HLProofExerciseZ3Checker extends NodeInfoManager implements ExerciseFeedbackGiver {
  ...
  constructor(nodeInfo: AlrNodeInfo, protected readonly env: Z3Env, hoareTripleChecker?: AnswerChecker<HoareTriple>) {
    super(nodeInfo);
...
export class IsLegitHoareTripleZ3Checker extends NodeInfoManager implements AnswerChecker<HoareTriple> {
  constructor(nodeInfo: AlrNodeInfo, protected readonly env: Z3Env) {
    super(nodeInfo);
  }
...
*/
function naivelySegmentIntoHoareTriples(nodeInfo: AlrNodeInfo, proofSteps: CoreProofStepAlrNode[]): HoareTripleAlrNode[] {
...
//   static make(nodeInfo: AlrNodeInfo, env: Z3Env, officialAnswer: string) {
//     return new Z3EqChecker(nodeInfo, env, Z3EqChecker.parseToAssertion(officialAnswer).toZ3(env));
//   }

//   private constructor(nodeInfo: AlrNodeInfo, env: Z3Env, officialAnswer: z3.Bool<"main">) {
//     super(nodeInfo);
