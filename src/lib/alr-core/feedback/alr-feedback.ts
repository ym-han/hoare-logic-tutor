import { AlrId, DefaultAlrNode, PlainStrContentSource, PlainStrContentAlrNode } from '$lib/alr-core/index.ts';
import type { AlrContext, AlrNode, AlrNodeInfo } from '$lib/alr-core/index.ts';
...
export abstract class BaseFeedbackAlrNode extends DefaultAlrNode {
  ...
  constructor(nodeInfo: AlrNodeInfo, feedback?: Feedback, body?: FeedbackBodyAlrNode) {
    super(nodeInfo);
...
export class FeedbackAlrNode extends BaseFeedbackAlrNode {
  ...
  static make(nodeInfo: AlrNodeInfo, feedback?: Feedback) {
    const body = feedback ? PlainStrContentSource.toAlr(nodeInfo, feedback.getBody()) : undefined;
    return new FeedbackAlrNode(nodeInfo, feedback, body);
  }

  protected constructor(nodeInfo: AlrNodeInfo, feedback?: Feedback, body?: FeedbackBodyAlrNode) {
  ...
  map(context: AlrContext, f: <A extends AlrNode>(fContext: AlrContext, node: A) => A) {
    ...
    const newFeedbackAlr = new FeedbackAlrNode(this.makeNodeInfo(context), this.feedback, newBody);
...
export class EmptyFeedbackAlrNode extends BaseFeedbackAlrNode {
  ...
  constructor(nodeInfo: AlrNodeInfo) {
    super(nodeInfo);
  }
}
...
export class CorrectAttemptFeedbackAlrNode extends FeedbackAlrNode {
  ...
  static make(nodeInfo: AlrNodeInfo, feedback?: Feedback) {
    const body = feedback ? PlainStrContentSource.toAlr(nodeInfo, feedback.getBody()) : undefined;
    return new CorrectAttemptFeedbackAlrNode(nodeInfo, feedback, body);
  }
}
...
export class IncorrectAttemptFeedbackAlrNode extends FeedbackAlrNode {
  ...
  static make(nodeInfo: AlrNodeInfo, feedback?: Feedback) {
    const body = feedback ? PlainStrContentSource.toAlr(nodeInfo, feedback.getBody()) : undefined;
    return new IncorrectAttemptFeedbackAlrNode(nodeInfo, feedback, body);
  }
...
export class StylesOnlyIncorrectAttemptFeedbackAlrNode extends IncorrectAttemptFeedbackAlrNode {
  $type = 'IncorrectAttemptOnlyStylesFeedbackAlrNode';

  protected feedback = undefined;
  protected body = undefined;

  static make(nodeInfo: AlrNodeInfo) {
